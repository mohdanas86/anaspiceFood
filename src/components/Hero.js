      ...
      <div className="hero-content text-neutral-content text-center">
        <div className="max-w-[60%]">
          <h1 className="mb-5 text-5xl font-bold">
            AnaSpice – Adding flavor to your doorstep.
          </h1>
          <p className="mb-5">
          ...
          <Link to="/catogery">
            <button className="btn btn-primary bg-[--primary-color] hover:bg-[--secondary-color] border-0 w-[30%] duration-300 hover:translate-x-1 rounded-full">
              Order Now
            </button>
          </Link>
        </div>
