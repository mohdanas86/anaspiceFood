...
//     <div className="w-full flex justify-center items-center px-10 py-2 relative overflow-hidden">
//       {/* {loading ? (
//         <p>Loading dishes...</p> // Show loading message while fetching
//       ) : dishes ? ( // Check if dishes array is not empty
        
//       ) : (
//         <p>No dishes available.</p> // Handle case when no dishes are fetched
//       )}
//     </div> */}
